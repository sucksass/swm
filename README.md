<h1 align="center">SWM</h1><h2 align="center">swm — Static Window Manager</h2><p align="center">
...
"swm" is a reconstructed X11 window manager with a deliberately minimal design, traditional Xlib interfaces, configurable tags, layouts, floating windows, fullscreen support, EWMH/ICCCM behavior, and all the other things you'd expect from a window manager that definitely knows what it's doing.

It was made with AI.

It was reviewed by AI.

It was questioned by another AI.

The AI argued with the AI.
...
- A tiny standalone transient-window test client
...
Yes, the source file is still called "wewm.c".
...
The name eventually evolved from the extremely respectable Worst Ever Window Manager into the slightly more respectable Static Window Manager.

Because apparently "swm" sounds more professional.
...
No DWM code was touched, read, or modified by the AI.
...
<h2 align="center">swm — Static Window Manager</h2><p align="center">
  <strong>Previously wewm — Worst Ever Window Manager™</strong>
</p><p align="center">
  Powered by X11.<br>
  Fueled by C.<br>
  Reviewed by AI.<br>
